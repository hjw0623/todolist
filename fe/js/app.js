(function (window) {
	...
	$('.filters').on("click", "a", function(event){
		event.preventDefault(); //for event cancel 
	...
	function doCheckFilter(){
		...
		filterView(selectedFilter);
	}//end of doCheckFilter

	//filter view - filter체크(doCheckFilter)를 통해 분류한 리스트를 보여준다.
